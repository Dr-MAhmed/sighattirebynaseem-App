...
export function CalligraphyContent({ initialCategory, initialProducts }: CalligraphyContentProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      ...
      <CategoryHeader
        title={category?.name || "Calligraphy Abayas"}
        description={
          category?.description ||
          "Discover our exquisite collection of calligraphy abayas featuring beautiful Arabic script and artistic designs. Perfect for special occasions and religious events."
        }
      />
