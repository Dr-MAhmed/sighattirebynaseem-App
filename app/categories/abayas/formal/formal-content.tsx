...
interface FormalContentProps {
  initialCategory: CategoryType | null;
  initialProducts: ProductType[];
}

export function FormalContent({ initialCategory, initialProducts }: FormalContentProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      ...
      <CategoryHeader
        title={category?.name || "Formal Abayas"}
        description={
          category?.description ||
          "Discover our elegant collection of formal abayas perfect for special occasions, business meetings, and formal events. Sophisticated designs that make a lasting impression."
        }
      />
