...
interface OccasionWeddingContentProps {
  initialCategory: CategoryType | null;
  initialProducts: ProductType[];
}

export function OccasionWeddingContent({ initialCategory, initialProducts }: OccasionWeddingContentProps) {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      ...
      <div className="mb-6">
        <nav className="flex text-sm text-muted-foreground">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">Occasion & Wedding</span>
        </nav>
      </div>

      <CategoryHeader
        title={category?.name || "Occasion & Wedding Abayas"}
        description={
          category?.description ||
          "Discover our stunning collection of occasion and wedding abayas. Perfect for special celebrations, weddings, and formal events. Elegant designs that make you feel beautiful and confident."
        }
      />
