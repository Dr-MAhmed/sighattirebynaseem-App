...
interface UmrahEidContentProps {
  initialCategory: CategoryType | null;
  initialProducts: ProductType[];
}

export function UmrahEidContent({ initialCategory, initialProducts }: UmrahEidContentProps) {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      ...
      <div className="mb-6">
        <nav className="flex text-sm text-muted-foreground">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">Umrah & Eid</span>
        </nav>
      </div>

      <CategoryHeader
        title={category?.name || "Umrah & Eid Abayas"}
        description={
          category?.description ||
          "Discover our special collection of abayas perfect for Umrah and Eid celebrations. Elegant designs that combine comfort with spiritual significance, perfect for your sacred journey and festive occasions."
        }
      />
