...
interface CasualDailyWearContentProps {
  initialCategory: CategoryType | null;
  initialProducts: ProductType[];
}

export function CasualDailyWearContent({ initialCategory, initialProducts }: CasualDailyWearContentProps) {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      ...
      <div className="mb-6">
        <nav className="flex text-sm text-muted-foreground">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">Casual Daily Wear</span>
        </nav>
      </div>

      <CategoryHeader
        title={category?.name || "Casual Daily Wear Abayas"}
        description={
          category?.description ||
          "Comfortable and stylish abayas perfect for everyday wear. Discover our collection of casual abayas that combine comfort with elegance."
        }
      />
