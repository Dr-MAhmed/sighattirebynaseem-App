...
export function ModestMaxiDressesContent({ initialCategory, initialProducts }: { 
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Modest Maxi Dresses"}
        description={
          category?.description ||
          "Discover our collection of elegant and modest maxi dresses, perfect for any occasion. From casual to formal, find your perfect style."
        }
      />
