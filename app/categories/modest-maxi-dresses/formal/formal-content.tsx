...
export function FormalContent({ initialCategory, initialProducts }: FormalContentProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      ...
      <CategoryHeader
        title={category?.name || "Formal Modest Maxi & Dresses"}
        description={
          category?.description ||
          "Elegant and sophisticated modest dresses for special occasions. Perfect for formal events, weddings, and celebrations."
        }
      />
