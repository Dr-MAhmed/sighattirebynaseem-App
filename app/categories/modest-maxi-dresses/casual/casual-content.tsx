...
export function CasualContent({ initialCategory, initialProducts }: { 
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Casual Maxi Dresses"}
        description={
          category?.description ||
          "Discover our collection of comfortable and stylish casual maxi dresses, perfect for everyday wear."
        }
      />
