...
export function HijabsContent({ initialCategory, initialProducts }: { 
  ...
  return (
    <div className="container px-4 py-12 mx-auto md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Hijabs"}
        description={
          category?.description ||
          "Beautiful and modest hijabs in various styles and materials. Find the perfect hijab to complement your look."
        }
      />
