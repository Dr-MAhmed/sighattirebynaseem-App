...
export function IraniChadarContent({ initialCategory, initialProducts }: { 
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Iranian Chadar"}
        description={
          category?.description ||
          "Discover our collection of elegant Iranian Chadars, known for their premium quality and beautiful designs. Perfect for special occasions and daily wear."
        }
      />
        ...
        <div className="flex-1">
          ...
          {!filteredProducts || filteredProducts.length === 0 ? (
            <div className="rounded-lg border bg-card p-8 text-center">
              <h2 className="text-xl font-medium">Coming Soon, Insha'Allah</h2>
