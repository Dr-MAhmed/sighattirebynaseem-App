...
export function EssentialsContent({ initialCategory, initialProducts }: { 
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        ...
        description={
          ...
          "Must-have modest clothing essentials for your wardrobe. These versatile pieces are perfect for everyday wear."
        }
      />
