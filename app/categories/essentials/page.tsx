...
import { EssentialsContent } from "./essentials-content";
...
async function EssentialsPage() {
  try {
    const [categoryData, productsData] = await Promise.all([
      getCategoryBySlug("essentials"),
      getProductsByCategory("essentials", 100),
    ]);
    ...
    console.error("Error in EssentialsPage:", error);
    return (
      <Suspense fallback={<LoadingFallback />}>
        <EssentialsContent 
