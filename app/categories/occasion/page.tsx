...
export default function OccasionPage() {
    ...
    const fetchData = async () => {
      ...
      try {
        const [categoryData, productsData] = await Promise.all([
          getCategoryBySlug("occasion"),
          getProductsByCategory("occasion", 100),
        ]);
        ...
        setCategory({
          ...
          name: "Occasion",
          slug: "occasion",
          description: "Luxurious abayas for special celebrations and events",
          isActive: true,
        });
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Occasion"}
        description={
          category?.description ||
          "Luxurious and elegant abayas designed for special celebrations and events."
        }
      />
