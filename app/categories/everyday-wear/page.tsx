...
export default function EverydayWearPage() {
    ...
    const fetchData = async () => {
      ...
      try {
        const [categoryData, productsData] = await Promise.all([
          getCategoryBySlug("everyday-wear"),
          getProductsByCategory("everyday-wear", 100),
        ]);
        setCategory(categoryData);
        setProducts(productsData);
      } catch (error) {
        setCategory({
          categoryId: "everyday-wear",
          name: "Everyday Wear",
          slug: "everyday-wear",
          description: "Comfortable and stylish abayas for daily use",
          isActive: true,
        });
        setProducts([]);
      } finally {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Everyday Wear"}
        description={
          category?.description ||
          "Comfortable and stylish abayas designed for your everyday needs and activities."
        }
      />
