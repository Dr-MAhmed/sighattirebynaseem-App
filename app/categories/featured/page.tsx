...
function FeaturedContent() {
    ...
    const fetchData = async () => {
      ...
      try {
        const [categoryData, productsData] = await Promise.all([
          getCategoryBySlug("featured"),
          getProductsByCategory("featured", 100, !!refresh),
        ]);
        ...
        setCategory({
          ...
          slug: "featured",
          description: "Our handpicked selection of the finest abayas",
          isActive: true,
        });
        setProducts([]);
      } finally {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 lg:py-16">
      <CategoryHeader
        title={category?.name || "Featured Products"}
        description={
          category?.description ||
          "Our handpicked selection of the finest abayas, showcasing exceptional quality and design."
        }
      />
